...
function generateProfessional(index: number): Professional {
  ...
  return {
    ...
    hourlyRate: level === 'STANDARD' ? 1250 : level === 'PRO' ? 2000 : 3000,
...
export const MOCK_BOOKINGS: Booking[] = [
  {
    ...
    status: 'COMPLETED',
    pricing: { level: 'PRO', baseRate: 2000, count: 2, duration: 3, subtotal: 12000, platformFee: 960, total: 12960 },
    responses: [],
  ...
  },
  {
    ...
    status: 'COMPLETED',
    pricing: { level: 'STANDARD', baseRate: 1250, count: 4, duration: 5, subtotal: 25000, platformFee: 2000, total: 27000 },
    responses: [],
  ...
  },
  {
    ...
    status: 'CONFIRMED',
    pricing: { level: 'STANDARD', baseRate: 1250, count: 6, duration: 8, subtotal: 60000, platformFee: 4800, total: 64800 },
    responses: [],
